package com.apurv.ceiryamldemo2.config;
...
public class Config {
    ...
    public OpenAPI springShopOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("Ceir API")
                        .description("Ceir API for blocking and unblocking of devices")
                        .version("1.0")
...
////import com.apurv.ceiryamldemo2.controller.Controller;
////
...
////                                .build()))
////                .tags(new Tag("Ceir Service", "All apis relating to ceir")); // <23>
